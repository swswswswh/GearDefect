...
```bash
python main_window.py --weights yolov5m.pt --data your_dataset.yaml --freeze 10
```
...
```bash
python main_window.py --weights yolov5m.pt --data your_dataset.yaml --freeze 24
```
...
python main_window.py --batch 48 --weights yolov5m.pt --data voc.yaml --epochs 50 --cache --img 512 --hyp hyp.finetune.yaml --freeze 10
```
